...
export type MutationStatuesFragment = { __typename?: 'UserMutationResponse', code: number, success: boolean, message?: Maybe<string> };
...
export const MutationStatuesFragmentDoc = gql`
    fragment mutationStatues on UserMutationResponse {
  code
  success
  message
}
